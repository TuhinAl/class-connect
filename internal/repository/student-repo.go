...
func (studentStore *StudentStore) Create(ctx context.Context, student *models.Student)  (*models.Student, error) {
	...
	query := `INSERT INTO student_information (
	  ...
	  course, email, is_active, class_id, password, father_phone, admission_date, admission_fee, 
